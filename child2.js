...
//
//
//     it('122 Pasar de empathy step a adults concerns',function () {
//         browser.sleep(2000);
...
//
//
//      it('123 No se puede crear un adult concern con los campos vacios',function () {
//         browser.sleep(2000);
...
//
//
//     it('124 Cuando se esta creando un adult concern, se puede cancelar',function () {
//         element(by.buttonText("Cancel")).click();
//         browser.sleep(3000);
//
//         expect(browser.getTitle()).toEqual("Define Adult's Concern");
