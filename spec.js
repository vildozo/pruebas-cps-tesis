...
//          logger.log('info','');
    ...
    it('44 Al visualizar mensaje si se desea pasar a Adults concern se puede cancelar',function () {
        ...
        it('45 Al visualizar mensaje si se desea pasar a Adults concern se puede pasar al siguiente step adult concern',function () {
            element(by.id("child_selected")).click();
            browser.sleep(5000);
            element(by.id("laggingSkillsID")).click();
            element(by.binding("laggingSkill.description")).click();
        ...
        it('46 No se puede crear un adult concern con los campos vacios',function () {
            element(by.id("child_selected")).click();
            browser.sleep(5000);
            element(by.id("laggingSkillsID")).click();
            element(by.binding("laggingSkill.description")).click();
    ...
    it('47 Cuando se esta creando un adult concern, se puede cancelar',function () {
        element(by.id("child_selected")).click();
        browser.sleep(5000);
        element(by.id("laggingSkillsID")).click();
    ...
    it('48 Crear un adult concern',function () {
        element(by.id("child_selected")).click();
        browser.sleep(5000);
        element(by.id("laggingSkillsID")).click();
    ...
    // it('49 Cuando se esta editando un adult concern no se puede dejar el campo de Adult concern vacio',function () {
    //     element(by.id("child_selected")).click();
    //     browser.sleep(5000);
    //     element(by.id("laggingSkillsID")).click();
    //
